        ...
        <div className="card--header">
          ...
          <div className="card--body">
              ...
              <div className="card--item-qty">
                <div className="card--qty">
                  <button
                    ...
                    onClick={() => changeCartQty("decrement", product._id)}
                  >
                    -
                  </button>
                  <label type="text" className="card--qty-input">
                    {product.qty}
                  </label>
                  <button
                    className="btn-plus"
                    onClick={() => changeCartQty("increment", product._id)}
                  >
                    +
                  </button>
                </div>
            ...
            <div className="card--buttons--horizontal">
              ...
              <button onClick={addToWishlist} className="btn btn--primary">
                Move To Wishlist
              </button>
            </div>
          </div>
